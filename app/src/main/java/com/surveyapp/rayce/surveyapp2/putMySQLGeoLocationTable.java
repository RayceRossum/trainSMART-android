 ...
 */
class putMySQLGeoLocationTable extends AsyncTask<String, String, String> {

    private boolean LOGGED_IN = false;
    public SQLiteDatabase _db;
    DBHelper dbhelp;

    putMySQLGeoLocationTable(DBHelper dbhelp){
        this.dbhelp = dbhelp;
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            ...
            Log.d("request!", "putMySQLGeoLocationTable build rec: " + geoLocationsList.size() );
            ...
            if (success == 1) {
                ...
                Log.d("request!", "putMySQLGeoLocationTable Success: ");
            } else {
            ...
            e.printStackTrace();
            Log.d("request!", "putMySQLGeoLocationTable exception > " + e.toString());
        }
        Log.d("request!", "putMySQLGeoLocationTable.doInBackground end");
        return null;
    }
}
